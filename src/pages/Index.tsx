...
import ScrollSpeedGame from '../components/ScrollSpeedGame';
...
const Index = () => {
  ...
  const [isScrollGameModalOpen, setIsScrollGameModalOpen] = useState(false);
      ...
      <MobileOptimizedLayout>
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-orange-900/20 text-white">
          ...
          <div className={showWelcomeAnimation ? 'opacity-0' : 'opacity-100 transition-opacity duration-500'}>
              ...
              <section id="games" className="py-20 bg-gradient-to-br from-black via-gray-900 to-orange-900/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <motion.div
                      className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl border border-orange-500/30"
                      whileHover={{ scale: 1.02 }}
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.6 }}
                    >
                      <h3 className="text-xl font-bold text-orange-400 mb-3">🏃‍♂️ Game of Scroll</h3>
                      <p className="text-gray-300 mb-4 text-sm">
                        Navigate through obstacles at high speed! Test your reflexes in this addictive speed challenge.
                      </p>
                      <button
                        onClick={() => setIsScrollGameModalOpen(true)}
                        className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-2 px-4 rounded-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-200"
                      >
                        Start Scrolling
                      </button>
                    </motion.div>
            ...
            {isScrollGameModalOpen && (
              <ScrollSpeedGame onClose={() => setIsScrollGameModalOpen(false)} />
            )}
